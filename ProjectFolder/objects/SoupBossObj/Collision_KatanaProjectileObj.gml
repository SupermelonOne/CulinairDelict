if (!beingHit && currentPhase != bossPhase.die){
	if (other != BeanBossProjectileObj || other.splat){
		shakeTimer = shakeTime;
		myHealth -= other.parentObj.damage;
		global.energy += other.parentObj.damage * (global.maxEnergy / global.bossHealthMax);
