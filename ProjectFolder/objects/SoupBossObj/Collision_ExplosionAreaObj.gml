if (other.timer <= other.activeTime && currentPhase != bossPhase.die){
	shakeTimer = shakeTime;
	myHealth -= other.exploDamage;
	global.energy += other.exploDamage * (global.maxEnergy / global.bossHealthMax);
